...
type Bookings = FunctionReturnType<typeof api.bookings.listAll>;
...
export function AdminBookings({ bookings }: { bookings: Bookings }) {
  if (bookings.length === 0) {
    return <div className="admin-state admin-empty"><CalendarX2 size={28} /><strong>No bookings yet</strong><span>New bookings will appear here.</span></div>;
  }
  return (
